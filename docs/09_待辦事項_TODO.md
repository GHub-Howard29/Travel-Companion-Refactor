...
- V3.3.0 發布前，不得開啟 V3.4.0 或其他新版本的功能開發。
- 本版本期間的小修正、缺陷修復與驗證調整全部掛在 V3.3.0，不另開版本。
- 只有 V3.3.0 已完成發布後，才能排定下一個版本號。
...
- [ ] V3.3.0 外幣換算主功能回歸全部通過。
- [ ] V3.3.0 無已知需改善問題；若有問題，先在 V3.3.0 修正。
- [ ] V3.3.0 已完成正式發布。
